...
class AmenitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amenity" do
    assert_difference('Amenity.count') do
      post amenities_url, params: { amenity: { name: @amenity.name, popularity: @amenity.popularity } }
    end
  ...
  test "should update amenity" do
    patch amenity_url(@amenity), params: { amenity: { name: @amenity.name, popularity: @amenity.popularity } }
